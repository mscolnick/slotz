...
import { Component, Fillable, IManager, Listener, Name } from './types';
...
export class Manager implements IManager {
  ...
  private handleFillUpdated({ fill }: { fill: Fillable }) {
    ...
    if (component) {
      ...
      throw new Error('[handleFillUpdated] component was expected to be defined');
    }
  }
  ...
  private handleFillUnmount({ fill }: { fill: Fillable }) {
    ...
    if (!oldComponent) {
      throw new Error('[handleFillUnmount] component was expected to be defined');
    }
